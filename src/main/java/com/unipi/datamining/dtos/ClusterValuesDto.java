...
public class ClusterValuesDto implements Serializable {
    ...
    public ClusterValuesDto() {
    }

    public ClusterValuesDto(double extraversion, double agreeableness, double conscientiousness, double neuroticism, double openness, double timeSpent) {
